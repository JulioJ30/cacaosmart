    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-transparent" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
          <!-- Cacao Smart Trade -->
          <img src="public/logosolo.png" alt="" style="width:30px">
          <p class="d-inline align-middle">Cacao Smart Trade</p>
        </a>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">
              Somos una consultoría conformada por profesionales emprendedores altamente capacitados con experiencia en estudios de mercados, operatividad logística internacional y aduanera, brindándole la flexibilidad y confiabilidad en la búsqueda de nuevos mercados internacionales. 
            </p>
    ...
    <section class="p-0" id="portfolio">
      ...
      <div class="container-fluid p-0">
        ...
        <!-- <div class="row no-gutters popup-gallery">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="public/servicios2/bg2.png">
              <img class="img-fluid" src="public/servicios2/bg2.png" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="public/servicios2/bg3.png">
              <img class="img-fluid" src="public/servicios2/bg3.png" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="public/servicios2/bg4.png">
              <img class="img-fluid" src="public/servicios2/bg4.png" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="public/servicios2/bg5.png">
              <img class="img-fluid" src="public/servicios2/bg5.png" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="public/servicios2/bg6.png">
              <img class="img-fluid" src="public/servicios2/bg6.png" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto text-center">
            ...
            <p>
              <a href="mailto:cacao@gmail.com">cacao@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
